...
teuscher = Chocolatier.create("name" => "Teuscher", "logo_url" => "http://www.frenchculturalcenter.org/fccb/assets/Image/teuscher%20chocolates%20of%20switzerland%20jpg.jpg", "origin" => "Zurich, Switzerland", "website" => "http://www.teuscher.com/")
vosges = Chocolatier.create("name" => "Vosges Haut-Chocolat", "logo_url" => "http://cdn.vosgeschocolate.com/images/vosges-logo_holiday.gif", "origin" => "Chicago, Illinois, USA", "website" => "http://www.vosgeschocolate.com/")
sharffen = Chocolatier.create("name" => "Scharffen Berger Chocolate Maker, Inc.", "logo_url" => "http://www.scharffenberger.com/lib/img/logos/scharffen-berger.png", "origin" => "Berkeley, California, USA", "website" => "http://www.scharffenberger.com/")
jacquestorres = Chocolatier.create("name" => "Jacques Torres Chocolate", "logo_url" => "http://www.candyindustry.com/ext/resources/images/February-2013-EVERYDAY/Jacque-Torres-logoHOME.jpeg?1360174266", "origin" => "New York, New York, USA", "website" => "http://www.mrchocolate.com/")
normanlove = Chocolatier.create("name" => "Norman Love Confections", "logo_url" => "http://www.normanloveconfections.com/images/theme-normanlove/logo.png", "origin" => "Ft. Myers, Florida, USA", "website" => "http://www.normanloveconfections.com/")
valrhona = Chocolatier.create("name" => "Valrhona", "logo_url" => "http://www.valrhona.com/App_Themes/FO/img/logoValrhona.gif", "origin" => "France", "website" => "http://www.valrhona.com/accueil.aspx")
godiva = Chocolatier.create("name" => "Godiva Chocolatier", "logo_url" => "http://www.godivachocolates.eu/images/stories/logo.png", "origin" => "Brussels, Belgium", "website" => "http://www.godivachocolates.eu/en/godiva-chocolatier-since-1926")
richarddonnelly = Chocolatier.create("name" => "Richard Donnelly Fine Chocolates", "logo_url" => "https://www.donnellychocolates.com/wp-content/themes/chocolate/images/top_title.gif", "origin" => "Santa Cruz, California, USA", "website" => "https://www.donnellychocolates.com/")
richart = Chocolatier.create("name" => "Richart", "logo_url" => "https://www.richart-chocolates.com/chocolates/RTUS/theme/images/logo_RICHART.jpeg", "origin" => "Paris, France", "website" => "https://www.richart-chocolates.com/chocolates/")
puccini = Chocolatier.create("name" => "Puccini Bomboni", "logo_url" => "http://www.puccinibomboni.com/images/logohome.png", "origin" => "Amsterdam, Netherlands", "website" => "http://www.puccinibomboni.com/")
